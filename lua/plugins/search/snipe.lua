return {
  {
    ...
    config = function()
      ...
      local function new_dir(dir_name)
        ...
        if uv.fs_realpath(dir_name) == cwd then dir_name = cwd end
        ...
        while true do
          ...
          if dir_name ~= uv.cwd() then ent[1].name = dir_name .. "/" .. ent[1].name end
      ...
      local function set_keymaps(m)
        ...
        vim.keymap.set("n", "..", function()
          ...
          local dual_it = function() return cwd_it(), dir_it() end
          ...
          if tot == matched then unmatched = dir:gsub(cwd, "") end
      ...
      local function open_file_manager()
        ...
        menu:open(items, function(m, i)
          ...
          if item.type == "file" then
            icon = mini_icons.get("file", item.name)
      ...
      vim.keymap.set("n", "<leader>od", open_file_manager)
    end,
  },
}
