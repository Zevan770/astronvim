return {
  {
    ...
    -- config = true, -- default settings (commented out as it's duplicated below)
    ...
    opts = {
      ...
      handler_options = {
        ...
        -- search_engine = "https://search.brave.com/search?q=", -- or you can pass in a custom search engine (commented out as duplicate)
        select_for_search = false, -- if your cursor is e.g. on a link, the pattern for the link AND for the word will always match. This disables this behaviour for default so that the link is opened without the select option for the word AND link

        git_remotes = { "upstream", "origin" }, -- list of git remotes to search for git issue linking, in priority
        -- git_remotes = function(fname) -- you can also pass in a function (commented out as duplicate)
        ...
        -- git_remote_push = function(fname) -- you can also pass in a function (commented out as duplicate)
