...
return {
  {
    ...
    config = function()
      ...
      -- Setup keymaps
      vim.keymap.set("n", "gk", function() require("hover").open() end, { desc = "hover.nvim (open)" })
      ...
      vim.keymap.set("n", "]h", function() require("hover").switch "next" end, { desc = "hover.nvim (next source)" })
