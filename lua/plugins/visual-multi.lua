return {
  ...
  dependencies = {
    ...
    opts = function(_, opts)
      ...
      maps.n["<A-S-k>"] = { "<C-u>call vm#commands#add_cursor_up(0, v:count1)<cr>", desc = "Add cursor above" }
      maps.n["<A-S-J>"] = { "<C-u>call vm#commands#add_cursor_down(0, v:count1)<cr>", desc = "Add cursor below" }
    end,
  },
}
